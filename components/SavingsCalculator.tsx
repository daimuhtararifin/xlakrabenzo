...
export const SavingsCalculator: React.FC = () => {
  ...
  // Retail Benchmark: Xtra Combo Plus ~ Rp 215.000
  // Akrab Variants for comparison: XXL (95k), XL (75k)
  const RETAIL_PRICE = 215000;
  ...
  useEffect(() => {
    ...
    const obj = { val: savingsMonthly - (variant === 'XXL' ? -20000 : 20000) }; // Mock prev value logic
    gsap.to(obj, {
        val: savingsMonthly,
        duration: 0.5,
        onUpdate: () => {
  ...
  }, [variant, currentPrice, savingsMonthly]);
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="font-inter text-[#64748B] text-lg md:text-xl leading-relaxed">
            Bandingkan harga <span className="font-semibold text-slate-700">Xtra Combo Plus</span> (200rb-an) dengan Paket Akrab Premium kami. Sama-sama XL, tapi harga jauh berbeda.
          </p>
        </div>
                ...
                <div className="relative">
                    ...
                    <div className="flex justify-between items-end mb-2">
                        <span className="text-royal font-bold text-sm flex items-center gap-2">
                            <Smartphone size={16} /> Akrab Premium Kamu
                        </span>
            ...
            <div className="mt-12 bg-slate-50 p-6 rounded-2xl border border-slate-100 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-600 text-sm mt-1">
                        Hemat hingga <span className="font-bold text-emerald-600 bg-emerald-100 px-1 rounded">{formatRupiah(savingsYearly)}</span> per tahun. 
                        Cukup buat bayar UKT atau upgrade gadget baru! 🎓✨
                    </p>
                </div>
            </div>
